...
<body>
    ...
    <div>
        <table width="80%">
            <tr>
                <td colspan="3">
                    <strong style="color: blue">I. First enter site collection url and web site name, then
                        click "Lookup" button too display rest of form<br />
                    </strong>
                </td>
            </tr>
            <tr>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="50px" Visible="False" Width="100%">
            <table id="TABLE1" language="javascript" onclick="return TABLE1_onclick()" width="80%">
                <tr>
                    <td colspan="3" style="color: blue">
                        <strong>II. Then fill in rest of data and click "Create" button<br />
                        </strong>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center" colspan="3">
                        <asp:Button ID="cmdCreateList" runat="server" OnClick="cmdCreateList_Click" Text="Create New List" /></td>
                </tr>
            </table>
        </asp:Panel>
        <br />
