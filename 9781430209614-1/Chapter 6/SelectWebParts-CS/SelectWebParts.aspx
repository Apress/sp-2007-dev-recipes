<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="SelectWebParts.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    Select the web-parts you want to add to this web site, then click the Finish button
        ...
        <table cellpadding="10">
            ...
            <tr>
                <td colspan="2">
                    <asp:CheckBox ID="cbPVWP" runat="server" Text="Page Viewer Web Part" AutoPostBack="True" OnCheckedChanged="cbPVWP_CheckedChanged" /></td>
                <td colspan="1">
        ...
        <br />
        <asp:Button ID="cmdFinish" runat="server" Text="Finish" OnClick="Finish_Click" />
    </form>
</body>
</html>
