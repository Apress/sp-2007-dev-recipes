        ...
        <table>
            <tr>
                ...
                <td style="width: 169px">
                    <asp:LinkButton ID="LinkButton1" runat="server">Retrieve Templates</asp:LinkButton></td>
            </tr>
            <tr>
                <td style="width: 163px">
                    Template:</td>
            ...
            <tr>
                ...
                <td style="width: 100px">
                    <asp:Button ID="cmdCreateNewSiteCollection" runat="server" Text="Create New Site Collection" /></td>
                <td style="width: 169px">
                </td>
            </tr>
            <tr>
